        ...
        rx.el.main(
            rx.el.div(
                ...
                rx.el.div(
                    ...
                    document_selection_card(
                        "Factura Comercial",
                        "Crea facturas profesionales desglosadas con items, impuestos, subtotales y notas personalizadas. Formato estándar internacional.",
                        "receipt",
                        "/invoice",
                        "text-emerald-600",
                        "bg-emerald-50",
                    ),
                    class_name="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto px-4",
                ),
