...
class StatementState(rx.State):
    ...
    provider_name: str = "ZIEGLER LOGISTIC & CO. CORP"
    provider_address: str = "6801 NW 82ND AVE"
    provider_city_state_zip: str = "MIAMI, FLORIDA 33166"
    provider_phone: str = "305-4062006"
    client_name: str = "NOSGLOBAL"
    client_address: str = "CALLEJON PREBOL EDIFICIO SARAITH TORRE A"
    client_city: str = "2006 VALENCIA"
    client_state: str = "CARABOBO"
